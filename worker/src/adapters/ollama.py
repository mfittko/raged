...
from src.config import OLLAMA_URL, EXTRACTOR_MODEL_FAST, EXTRACTOR_MODEL_CAPABLE, EXTRACTOR_MODEL_VISION
...
{{
  ...
  "image_type": "..."
    ...
    async def _generate_structured(self, prompt: str, schema: Dict, model: str, max_retries: int = 3) -> Dict:
