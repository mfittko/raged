...
**Goal:** Fix all violations of rag-stack's own coding standards (AGENTS.md) — refactor fat handlers, add JSON Schema validation, structured errors, comprehensive tests, and CI/CD.
...
```bash
# rag-stack environment variables
